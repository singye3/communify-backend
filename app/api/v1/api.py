...
api_router.include_router(
    symbols.router, prefix="/symbols", tags=["Symbols & Categories"]
)
api_router.include_router(
    users.router, prefix="/users", tags=["Users - Current User (/me)"]
)
api_router.include_router(
    user_symbols_customization.router,
    prefix="/users/me/symbols",
    tags=["User Symbols Customization"],
)
api_router.include_router(
    admin.router, prefix="/admin", tags=["Admin - User Management"]
)
